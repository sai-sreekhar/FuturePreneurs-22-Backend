...
roundThreeRouter.route("/start/:teamId").post(auth, roundThreeRoutes.startRoundThree);
roundThreeRouter.route("/:teamId").post(auth, roundThreeRoutes.addOrDeleteItems);
roundThreeRouter
  .route("/submit/:teamId")
