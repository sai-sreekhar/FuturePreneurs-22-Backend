...
const errorCodes = {
  ...
  ROUND_ONE_NOT_STARTED: 32, //round one not started
  ROUND_ONE_COMPLETED: 33, //round one completed
  // ROUND_ONE_MAP_NOTSET: 34,
  // ROUND_TWO_ALREADY_STARTED: 35,
  ROUND_TWO_COMPLETED: 36,
  // ROUND_TWO_BOX_ALREADY_SUBMITTED: 37,
  ROUND_THREE_COMPLETED: 38, //round three completed
  // ROUND_THREE_DOCUMENT_NOT_FOUND: 39,
  BALANCE_EXCEEDED: 40,
  ITEMS_LIMIT_REACHED: 41,
  PREVIOUS_ROUNDS_NOT_DONE: 42,
  ROUND_ONE_NOT_COMPLETED: 43, // round one not completed
  // ROUND_THREE_COMPLETED: 44,
  ROUND_THREE_NOT_STARTED: 45, //round three not started
  ROUND_TWO_NOT_STARTED: 46,
};
